...
class Section2_imgsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.section2_img.index', [
            'section2_imgs' => $section2_imgs,
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.section2_img.edit', [
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            if (
                ...
                return redirect()
                    ->route('section2_img.edit', ['section2_img' => 1])
                    ->with(
                        'success',
                        'Escoja un formato de imagen válido (jpeg, png, jpg, gif, svg)'
                    );
