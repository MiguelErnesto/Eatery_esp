...
class Section3_category_imagesController extends Controller
{
    ...
    {
        $section3_category_images = section3_category_images::where(
            'section3_category_id',
            $request->section3_category_id
        )->get();
        $section3_category_name = section3_categories::where(
            'id',
            $request->section3_category_id
        )->get();
    ...
    {
        $section3_category = section3_categories::where(
            'name',
            $request->section3_category_image
        )->get();
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            if (
                ...
                return redirect()
                    ->route('section3_category_images.create')
                    ->with(
                        'success',
        ...
        return redirect()
            ->route('section3.edit', ['section3' => 1])
            ->with(
                'success',
                'Sección ' .
    ...
    public function edit($id)
    {
        ...
        $section3_category_name = section3_categories::where(
            'id',
            $section3_category_images->section3_category_id
        )->get();
        $categories = section3_categories::all();
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            if (
                ...
                return redirect()
                    ->route('section3_category_images.edit', [
                        'section3_category_images' => 1,
                    ])
                    ->with(
                        'success',
                        'Escoja un formato de imagen válido (jpeg, png, jpg, gif, svg)'
