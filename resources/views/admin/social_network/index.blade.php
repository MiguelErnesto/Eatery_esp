                        ...
                        <tbody>
                            @foreach ($social_networks as $social_network)
                                <tr>
                                        ...
                                        <div class="ratio ratio-1x1">
                                            <div>
                                                <a href="{{ URL::asset('/images/' . $social_network->image) }}"
                                                    target="_blank">
                                                    <img class='img-thumbnail img-md img-responsive rounded-circle'
                                    ...
                                    <td class="align-middle">
                                        <a
                                            href="{{ route('social_network.edit', ['social_network' => $social_network->id]) }}">
                                    ...
                                    <td class="align-middle">
                                        <form action="{{ route('social_network.destroy', [$social_network->id]) }}"
                                            method="POST">
                                            @method('DELETE')
                                            @csrf
                                            <button class="btn btn-link"
