    ...
    <div class="container w-75 p-4">
        <div class="card border border-dark">
            <div class="card-header bg-dark">
                <h5>{{ config('app.nav_section4') }} / Testimonios / Nuevo</h5>
            </div>

            <div class="card-body">
                <form id="section4_testimonials_form" action="{{ route('section4_testimonials.store') }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-outline">
                            <textarea class="form-control" id="testimonial_text" name="testimonial_text" id="textAreaExample1" rows="5"></textarea>
                        </div>
